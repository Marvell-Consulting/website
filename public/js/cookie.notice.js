(function () {
    ...
    var defaults = {
        messageLocales: {
            en: 'This website uses cookies. In order to continually improve this site, we remember and store information about how you use it to ensure you get the best experience.',
        },
        ...
        buttonBgColor: '#27ae60',
        buttonTextColor: '#fff',
        noticeBgColor: '#112a3e',
        noticeTextColor: '#fff',
        linkColor: '#27ae60',
        linkBgColor: '#000',
        linkTarget: '_blank',
    ...
    function createNotice(message, bgColor, textColor, fontFamily, position) {
        ...
        noticeStyle.padding = paddingBottomTop + 'px 20px';
        noticeStyle["text-align"] = 'center';
        noticeStyle["font-size"] = '1.5rem';
